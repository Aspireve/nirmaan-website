        ...
        <div className="flex xl:justify-evenly md:px-10 px-10 flex-wrap justify-center">
          <div className="flex-1 text-lg ">
            <div className="flex px-6">
              <img src="/email-48.png" alt="" className="w-16" />
            ...
            <div className="flex mt-3 px-6">
              <img src="/location-40.png" alt="" className="w-16 h-14 " />
              <div className="m-3">
          ...
          <div className=" flex-1 md:ml-60 mt-10 md:mt-0 glasseffect rounded-3xl h-[500px] mb-5 ">
            <form onSubmit={handleSubmit} className="p-6 w-50">
              ...
              <div className="flex flex-col">
                <label
                  htmlFor="email"
                  className="text-3xl mb-4 font-extralight"
                >
                  Email
                </label>
                <input
              ...
              <div className="flex flex-col">
                <label
                  htmlFor="message"
                  className="text-3xl font-extralight mb-20"
                >
                  Message
                </label>
                <textarea
