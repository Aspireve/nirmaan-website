      ...
      <div className="md:w-1/2 p-4 md:p-8 relative">
        <div className="text-white">
          ...
          <p className="text-lg italic">
            Nirmaan Hyperloop stands at the forefront of innovation, continually
            pushing boundaries in the realm of high-speed transportation. With
            an unwavering commitment to advancing technology, Nirmaan Hyperloop
            pioneers groundbreaking solutions that redefine the future of
            transportation.
          </p>
          <p className="text-lg italic">
            Fueled by a passion for efficiency and sustainability, the team
            tirelessly explores new horizons, ensuring that each stride brings
            us closer to a transformative and futuristic transportation
            landscape.
          </p>
        </div>
